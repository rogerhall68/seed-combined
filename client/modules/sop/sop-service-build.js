...
function buildStructure(data, rootId) {
	...
	// collapseIndex controls which heirarchical sop elements are visible in the UI
...
var SOPBuildService = function() {
	var srvc = this;
	srvc.buildStructure = buildStructure;
	srvc.buildSOP = buildSOP;
	srvc.buildContainer = buildContainer;
};

angular
.module('sop')
.service('SOPBuildService', [
	SOPBuildService
]);

})();

console.log('SOP Build Service Initialized');
